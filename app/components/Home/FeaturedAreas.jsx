    ...
    <div className="container mx-auto py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {areas.map((area) => (
          ...
          >
            <Image width={400} height={400} src={area.imageUrl} alt={area.name} className="w-full h-full object-cover" />
            <div className="absolute bottom-0 left-0 right-0 p-4 flex justify-between items-start">
              <div className='flex flex-row items-center'>
                ...
                <p className="text-sm text-gray-300 ml-2">({area.listings} listings)</p>
                <motion.div
                initial="initial"
